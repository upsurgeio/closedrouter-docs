...
description: "ClosedRouter supports structured outputs for compatible models, ensuring responses follow a strict JSON Schema.  
...
Structured outputs are supported on select ClosedRouter models:
...
With ClosedRouter, you can unify structured outputs across **OpenAI** and **Anthropic**, without needing different request formats.